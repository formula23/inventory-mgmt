...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery_typeahead__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery_typeahead___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery_typeahead__);
...
$.typeahead({
    ...
    callback: {
        ...
        onSendRequest: function onSendRequest(node, query) {
            // console.log('request is sent')
        },
        onReceiveRequest: function onReceiveRequest(node, query) {
...
$(function () {
    ...
    $('a.qb_update').click(function (e) {
        ...
        var $this = this;
        var data = { "in_qb": $(this).data('in_qb') ? 0 : 1 };
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function success(so_obj) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(44), __webpack_require__(3)(module)))
