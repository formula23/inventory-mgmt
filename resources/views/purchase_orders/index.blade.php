...
@section('content')
    ...
    {{--<div class="card mb-3">--}}
        ...
        {{--<div class="card-block">--}}
            ...
            {{--<div class="row">--}}
                {{--@foreach($units_purchased as $customer_type => $statuses)--}}
                {{--<div class="col-3">--}}
                    {{--<h5>{{ ucfirst($customer_type) }}--}}
                    {{--@if(stristr($customer_type, 'cultivator'))--}}
                        {{--<small><i>(Tax: {{ display_currency($purchase_orders->sum('tax')) }})</i></small>--}}
                    {{--@endif--}}
                    {{--</h5>--}}

                    {{--@foreach($statuses as $status => $uoms)--}}
                    {{--<strong>{{ ucfirst($status) }}</strong><br>--}}
                    {{--@foreach($uoms as $uom=>$purchased)--}}
                    {{--{{ $purchased }} {{$uom}}--}}
                    {{--@if($uom=='lb')--}}
                    {{--<small>({{number_format($purchased * config('highline.uom')['lb'],2)}} g)</small>--}}
                    {{--@endif--}}

                    {{--<br>--}}
                    {{--@endforeach--}}

                    {{--Total Grams: {{ number_format($units_purchased_total[$customer_type][$status]['total_grams'],2) }} g <br>--}}
                    {{--Cult. Tax: {{ display_currency($units_purchased_total[$customer_type][$status]['total_grams'] * config('highline.cultivation_tax.flower.gram')) }}<br>--}}
...
{{--                            <td>{{ display_currency($purchase_order->tax) }}</td>--}}
                            ...
                            <td>
                                ...
                                <a href="{{ route('purchase-orders.print_po', $purchase_order->id) }}"><i class="ion-printer"></i></a>
                            </td>
                        </tr>
                        @endforeach
