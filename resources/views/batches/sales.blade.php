    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                ...
                <h4><a href="{{ route('batches.show', $batch->ref_number) }}">{{ $batch->ref_number }}</a></h4>

                <p>
                    Available Inventory: {{ $batch->inventory }} {{ $batch->uom }}<br>
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        @foreach($sale_orders as $sale_order)
                            <tr>
                                ...
                                <td>{{ $sale_order->order_details->first()->units }} {{ $batch->uom }}</td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="6"></td>
                                <td>{{ $sale_orders->pluck('order_details')->collapse()->sum('units') }} {{ $batch->uom }}</td>
                                <td colspan="2"></td>
